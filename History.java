...
{
    ArrayList<Board> gameHistory = new ArrayList<Board>(); // Array that keeps the game board states. Index i corresponds to the game board state at step i
    int currIndex = 0; // Current index. Can be different from maxIndex when going forward and backward in the game
    ...
    // Detects a cycle of 1 in the game, ie if the board state is equal to the board state 2 steps back. 
